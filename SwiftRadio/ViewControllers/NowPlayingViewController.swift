...
import Spring
import FRadioPlayer
import LuciqSDK // Added by cursor for non-fatal reporting
...
class NowPlayingViewController: UIViewController {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        // End flow instrumentation ONLY when user navigates back from "Radio 1190"
        if isMovingFromParent, let currentStation = manager.currentStation, currentStation.name == "Radio 1190" {
